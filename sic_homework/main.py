...
#cd D:\program\code\python\sic_homework (進入資料夾位置)
#python main.py -s D:\program\code\python\sic_homework\input.sic -o D:\program\code\python\sic_homework\output
#                                              -s input(輸入路徑) -o output(輸出路徑)
